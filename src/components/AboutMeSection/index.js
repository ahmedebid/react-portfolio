        ...
        <section id="about-sec" className="about-me-section">
            ...
            <div className="about-me-details">
                <div className="about-me-col-1">
                    <p><b>I'm Ahmed, a front-end developer living in the beautiful city of Alexandria in Egypt 🌅.</b><br/><br/>I'm passionate about bringing digital products to life and creating engaging online experiences that put the user needs first and foremost. I've a strong background in engineering and research as I hold B.Sc. and M.Sc. degrees in Construction and Building Engineering from <a href="https://aast.edu/en/" target="_blank" rel="noreferrer noopener">AASTMT</a>.<br/><br/>My passion for web development started at a young age where I built my first website when I was 15 years old. However, I spent a couple of years, after graduating from university, in a different career path working in academia and preparing to be a professor 😅, but then I realized that my true passion is for technology and web development, and I made the transition back to what I loved 👨🏻‍💻❤️.<br/><br/>If I'm not coding, you'll find me reading a book 📖, listening to a podcast 🎧, or enjoying a walk by the sea 🌊.</p>
